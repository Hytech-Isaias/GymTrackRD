 ...
 * @returns {Promise<Object>} Exercise data including GIF, instructions, etc.
 */
export const fetchExerciseFromAPI = async (exerciseName) => {
 ...
 */
const searchLocalDatabase = (exerciseName) => {
