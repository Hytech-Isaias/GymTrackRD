...
import { getLocalBusinessSchema, getOrganizationSchema, getWebSiteSchema, getFAQSchema } from '../lib/seo/schema';
...
const faqData = [
  {
    ...
    answer: 'Our AI analyzes your fitness level, goals, available equipment, and schedule to create a personalized workout plan that continuously adapts based on your progress.'
  },
  {
    question: 'Can I use this if I`m a complete beginner?',
    answer: 'Absolutely! Our platform is designed for all fitness levels, starting with beginner-friendly exercises and progressively challenging you as you build strength.'
  },
  {
    question: 'Do I need gym equipment?',
    answer: 'No! You can customize your equipment preferences, and the AI will create workouts tailored to what you have available, even bodyweight-only options.'
  }
];
