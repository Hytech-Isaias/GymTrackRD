    ...
    >
      ...
      <div className="p-4 flex flex-col justify-between flex-grow bg-gradient-to-r from-transparent to-slate-900/50">
        <div className="flex justify-between items-start">
          <h3 className="text-lg font-bold text-white leading-tight group-hover:text-purple-400 transition-colors">{title}</h3>
          <Badge variant="outline" className="text-[10px] bg-white/5 border-white/10 backdrop-blur-md">{type}</Badge>
        </div>
        ...
        <div className="mt-auto flex justify-end">
          <Button size="sm" variant="ghost" className="text-purple-400 p-0 h-auto hover:bg-transparent hover:text-purple-300 group-hover:translate-x-1 transition-transform">
            Start Now &rarr;
          </Button>
        </div>
      </div>
