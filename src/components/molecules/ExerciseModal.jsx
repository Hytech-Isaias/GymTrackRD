...
import { X, Info, Dumbbell, Timer, Repeat, Target, Loader2 } from 'lucide-react';
import { getExerciseData } from '../../lib/exerciseDB';

export const ExerciseModal = ({ exercise, isOpen, onClose }) => {
                  ...
                  <div className="relative h-80 overflow-hidden rounded-t-2xl bg-surface-secondary">
                    <img
                      ...
                      onError={(e) => {
                        ...
                        e.target.src = 'https://images.unsplash.com/photo-1571019614242-c5c5dee9f50b?w=800&h=500&fit=crop&auto=format&q=80';
                      }}
                    />
                    ...
                    <div className="absolute bottom-6 left-6 right-6">
                      <h2 className="text-3xl font-bold text-text-primary mb-2">{exerciseData.name}</h2>
                  ...
                  <div className="p-6 space-y-6">
                    ...
                    <div className="grid grid-cols-3 gap-3">
                      <div className="glass-panel p-4 rounded-xl border border-primary/20 text-center">
                        <Repeat className="mx-auto mb-2 text-primary" size={20} />
                        <div className="text-lg font-bold text-text-primary">{exercise.sets || '3x12'}</div>
                        <div className="text-xs text-text-tertiary">Sets x Reps</div>
                      </div>
                      <div className="glass-panel p-4 rounded-xl border border-accent/20 text-center">
                        ...
                        <div className="text-lg font-bold text-text-primary">{exercise.rest || '60s'}</div>
                        <div className="text-xs text-text-tertiary">Rest Time</div>
                      </div>
                      <div className="glass-panel p-4 rounded-xl border border-secondary/20 text-center">
                        <Target className="mx-auto mb-2 text-secondary" size={20} />
                        <div className="text-lg font-bold text-text-primary">{exerciseData.targetMuscle}</div>
