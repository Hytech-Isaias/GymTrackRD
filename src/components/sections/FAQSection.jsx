...
const FAQS = [
  {
    ...
    answer: 'Our AI analyzes your fitness level, goals, available equipment, and schedule to create a personalized workout plan. It continuously adapts based on your progress, ensuring you`re always challenged at the right level.'
  },
  {
    id: 2,
    question: 'Can I use this if I`m a complete beginner?',
    answer: 'Absolutely! Our platform is designed for all fitness levels. The AI will start you with beginner-friendly exercises and gradually progress as you build strength and confidence.'
  },
  {
    id: 3,
    question: 'Do I need gym equipment?',
    answer: 'Not at all! You can set your equipment preferences (bodyweight only, dumbbells, full gym, etc.), and the AI will create workouts tailored to what you have available.'
  },
  {
    id: 4,
    question: 'How often should I work out?',
    answer: 'This depends on your goals and schedule. Our AI typically recommends 3-5 workouts per week for most goals, with built-in rest days for optimal recovery.'
  },
  {
    id: 5,
  ...
  },
  {
    ...
    answer: 'Yes! Our mobile app is available for both iOS and Android, with offline mode so you can access your workouts anywhere.'
  }
];
    ...
    <section id="faq" className="relative py-32 bg-background">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          ...
          >
            Everything you need to know about getting started with your fitness journey.
          </motion.p>
