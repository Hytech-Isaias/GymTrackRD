    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-background">
      ...
      >
        <div className="relative">
          ...
          <Dumbbell
            size={64}
            className="relative z-10 drop-shadow-[0_0_15px_rgba(189,104,238,0.5)]"
          />
        </div>
      </motion.div>
      ...
      >
        <div className="relative">
          ...
          <Zap
            size={48}
            className="relative z-10 drop-shadow-[0_0_15px_rgba(171,81,227,0.5)]"
          />
        </div>
      </motion.div>
      ...
      >
        <div className="relative">
          ...
          <Heart
            size={56}
            className="relative z-10 drop-shadow-[0_0_15px_rgba(210,131,255,0.5)]"
          />
        </div>
      </motion.div>
