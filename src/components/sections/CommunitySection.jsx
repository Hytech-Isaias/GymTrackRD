...
const StatCounter = ({ icon: Icon, value, label, suffix = '', inView }) => {
...
export const CommunitySection = () => {
  ...
  return (
    <section id="community" className="relative py-32 bg-background overflow-hidden">
      {/* Animated Background */}
      ...
      <div ref={ref} className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          ...
          >
            Be part of a global community crushing goals and redefining what's possible.
          </motion.p>
        </motion.div>
        ...
        >
          <StatCounter icon={Users} value={100000} suffix="+" label="Active Members" inView={inView} />
          <StatCounter icon={Dumbbell} value={2500000} suffix="+" label="Workouts Logged" inView={inView} />
          <StatCounter icon={Flame} value={50000000} suffix="+" label="Calories Burned" inView={inView} />
          <StatCounter icon={Trophy} value={75000} suffix="+" label="Goals Achieved" inView={inView} />
        </motion.div>
      </div>
    </section>
  );
