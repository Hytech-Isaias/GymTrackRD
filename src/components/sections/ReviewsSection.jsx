...
export const ReviewsSection = () => {
  ...
  return (
    <section id="reviews" className="relative py-32 bg-background overflow-hidden">
      {/* Background */}
            ...
            >
              <div className="flex items-center gap-3 mb-2">
                ...
                <div className="flex-1 min-w-0">
                  <p className="text-text-primary font-medium text-sm truncate">{review.author}</p>
                  <p className="text-text-tertiary text-xs truncate">{review.role}</p>
                </div>
              </div>
              ...
              <p className="text-text-secondary text-xs line-clamp-3">{review.text}</p>
            </motion.div>
          ))}
        </motion.div>
      </div>
