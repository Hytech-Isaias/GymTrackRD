...
const SERVICES = [
  {
    ...
    title: "Free Plan",
    description:
      "Get started with AI-powered workouts, basic tracking, and community support - completely free!",
    features: [
      "AI workout plans",
  ...
  },
  {
    ...
    title: "Premium Plan",
    description:
      "Unlock the full experience with advanced features, no ads, and premium support.",
    features: [
      "Everything in Free",
    ...
    <section id="services" className="relative py-32 bg-background">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          ...
          >
            Start free and upgrade anytime for an ad-free experience with
            premium features.
          </motion.p>
        </motion.div>
