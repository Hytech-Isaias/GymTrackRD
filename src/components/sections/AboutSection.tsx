        ...
        >
          ...
          <motion.div variants={slideInFromRight} className="space-y-8">
            <div>
              ...
              >
                We believe fitness should be accessible, personalized, and
                powered by cutting-edge technology. Our AI-driven platform
                adapts to your goals, schedule, and progress—making every
                workout count.
              </motion.p>
              ...
              >
                ...
                intelligent training, expert guidance, and a supportive
              ...
              {[
                {
                  icon: Target,
                  title: "Goal-Oriented",
                  description: "Every plan tailored to your unique objectives",
                },
                {
                  icon: Users,
                  title: "Community-Driven",
                  description: "Connect with motivated individuals worldwide",
                },
                {
                  icon: Award,
                  title: "Results-Focused",
                  description:
                    "Data-backed programs that deliver real outcomes",
                },
              ].map((value, index) => (
                <motion.div
                  key={index}
